...
if __name__ == '__main__':
    ...
    #     "select * from alice where area>=150;select * from alice where rooms=2;",
    #     'test.csv')
    # query = f"select * from {PreName} where area>=150;select * from {PreName} where rooms=2;"
    # mysql.search_and_save(query, 'test.csv')
    ...
    #
    # # Construct the query string with the PreName variable
    # query = f"select * from {PreName} where area>=150;select * from {PreName} where rooms=2;"
    #
    # # Execute the query and save the result to the output file
    # mysql.search_and_save(query, output_path)
