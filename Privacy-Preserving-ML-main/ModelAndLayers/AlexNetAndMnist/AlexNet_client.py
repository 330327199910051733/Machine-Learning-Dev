...
# import syft.frameworks.torch.tensors.interpreters.private as priv
...
net.load_state_dict(torch.load('../AlexNetAndMnist/MNIST_bak.pkl'))

# opset_version=13
dummy_input = torch.ones(100, 1, 28, 28)
# secure_model = onnx_converter.from_pytorch(net, dummy_input, party=client, device=device,opset_version=opset_version)
